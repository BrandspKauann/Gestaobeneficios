...
export default function MethodPage() {
  return <main><SiteHeader />
    ...
    <section className="inline-cta"><p className="eyebrow"><span /> Aplique o método</p><h2>Comece pelo seu cenário.</h2><Link className="button" href="/diagnostico">Fazer diagnóstico <span>↗</span></Link></section><SiteFooter /></main>;
}
