...
const profiles = [
  { number: "01", title: "Pequena empresa", people: "Até 99 colaboradores", headline: "Cresça sem levar planilhas e retrabalho junto.", copy: "Estruture uma operação simples, previsível e pronta para acompanhar o crescimento da equipe.", points: ["Responsável e rotina claros", "Benefícios com adesão real", "Custo previsível para o caixa"] },
...
export default function ForWhoPage() { return <main><SiteHeader />
  <section className="inner-hero compact-hero"><div className="inner-hero-copy"><p className="eyebrow"><span /> Eficiência em qualquer porte</p><h1>Reduza custos e retrabalho em cada fase de crescimento.</h1><p>Descubra quais ajustes podem gerar mais eficiência para o seu time, seu caixa e a maturidade atual do RH.</p></div></section>
