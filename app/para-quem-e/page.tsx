...
export default function ForWhoPage() { return <main><SiteHeader />
  ...
  <section className="inline-cta"><p className="eyebrow"><span /> Qual é o seu cenário?</p><h2>O tamanho orienta. A rotina confirma.</h2><p>Leve porte, fornecedores, horas e nível de integração para a mesma leitura.</p><Link className="button" href="/diagnostico">Começar diagnóstico <span>↗</span></Link></section><SiteFooter /></main>; }
